...
The goal of ggconc is to make it simple to visualize health and
socioeconomic inequalities through concentration curves, with seamless
ggplot2 integration that fits naturally into existing data visualization
workflows.

## Installation

You can install the development version of ggconc from
